...
def clone_css_files(environment, wordpress_staging_username, wordpress_staging_password):
    ...
    css_urls = [
        ...
        f"{base_url}/wp-content/plugins/advanced-tabs-block/build/blocks/tabs/style-index.css",
        f"{base_url}wp-content/plugins/genesis-blocks/dist/style-blocks.build.css?ver=1747819356",
