...
function _(l6, u5, t5) {
  ...
  return m(l6, e4, i6, r5, null);
}
function m(n3, t5, i6, r5, o4) {
...
function C(n3) {
  if (n3.__P && n3.__d) {
    var u5 = n3.__v, t5 = u5.__e, i6 = [], r5 = [], o4 = w({}, u5);
    o4.__v = u5.__v + 1, l.vnode && l.vnode(o4), z(n3.__P, o4, u5, n3.__n, n3.__P.namespaceURI, 32 & u5.__u ? [t5] : null, i6, null == t5 ? S(u5) : t5, !!(32 & u5.__u), r5), o4.__v = u5.__v, o4.__.__k[o4.__i] = o4, V(i6, o4, r5), u5.__e = u5.__ = null, o4.__e != t5 && M(o4);
  }
}
function M(n3) {
...
function I() {
  try {
    for (var n3, l6 = 1; i.length; ) i.length > l6 && i.sort(e), n3 = i.shift(), l6 = i.length, C(n3);
  } finally {
    i.length = I.__r = 0;
  }
}
function P(n3, l6, u5, t5, i6, r5, o4, e4, f5, c5, s6) {
  var a5, h6, y5, d6, w5, g3, _4, m5 = t5 && t5.__k || v, b3 = l6.length;
  for (f5 = A(u5, l6, m5, f5, b3), a5 = 0; a5 < b3; a5++) null != (y5 = u5.__k[a5]) && (h6 = -1 != y5.__i && m5[y5.__i] || p, y5.__i = a5, g3 = z(n3, y5, h6, i6, r5, o4, e4, f5, c5, s6), d6 = y5.__e, y5.ref && h6.ref != y5.ref && (h6.ref && D(h6.ref, null, y5), s6.push(y5.ref, y5.__c || d6, y5)), null == w5 && null != d6 && (w5 = d6), (_4 = !!(4 & y5.__u)) || h6.__k === y5.__k ? f5 = H(y5, f5, n3, _4) : "function" == typeof y5.type && void 0 !== g3 ? f5 = g3 : d6 && (f5 = d6.nextSibling), y5.__u &= -7);
  return u5.__e = w5, f5;
}
function A(n3, l6, u5, t5, i6) {
  var r5, o4, e4, f5, c5, s6 = u5.length, a5 = s6, h6 = 0;
  for (n3.__k = new Array(i6), r5 = 0; r5 < i6; r5++) null != (o4 = l6[r5]) && "boolean" != typeof o4 && "function" != typeof o4 ? ("string" == typeof o4 || "number" == typeof o4 || "bigint" == typeof o4 || o4.constructor == String ? o4 = n3.__k[r5] = m(null, o4, null, null, null) : d(o4) ? o4 = n3.__k[r5] = m(k, { children: o4 }, null, null, null) : void 0 === o4.constructor && o4.__b > 0 ? o4 = n3.__k[r5] = m(o4.type, o4.props, o4.key, o4.ref ? o4.ref : null, o4.__v) : n3.__k[r5] = o4, f5 = r5 + h6, o4.__ = n3, o4.__b = n3.__b + 1, e4 = null, -1 != (c5 = o4.__i = T(o4, u5, f5, a5)) && (a5--, (e4 = u5[c5]) && (e4.__u |= 2)), null == e4 || null == e4.__v ? (-1 == c5 && (i6 > s6 ? h6-- : i6 < s6 && h6++), "function" != typeof o4.type && (o4.__u |= 4)) : c5 != f5 && (c5 == f5 - 1 ? h6-- : c5 == f5 + 1 ? h6++ : (c5 > f5 ? h6-- : h6++, o4.__u |= 4))) : n3.__k[r5] = null;
  if (a5) for (r5 = 0; r5 < s6; r5++) null != (e4 = u5[r5]) && 0 == (2 & e4.__u) && (e4.__e == t5 && (t5 = S(e4)), E(e4, e4));
  return t5;
}
function H(n3, l6, u5, t5) {
  var i6, r5;
  if ("function" == typeof n3.type) {
    for (i6 = n3.__k, r5 = 0; i6 && r5 < i6.length; r5++) i6[r5] && (i6[r5].__ = n3, l6 = H(i6[r5], l6, u5, t5));
    return l6;
  }
  n3.__e != l6 && (t5 && (l6 && n3.type && !l6.parentNode && (l6 = S(n3)), u5.insertBefore(n3.__e, l6 || null)), l6 = n3.__e);
  do {
    l6 = l6 && l6.nextSibling;
  } while (null != l6 && 8 == l6.nodeType);
  return l6;
}
function T(n3, l6, u5, t5) {
...
function F(n3, l6, u5, t5, i6) {
  var r5, o4;
  n: if ("style" == l6) if ("string" == typeof u5) n3.style.cssText = u5;
  else {
    if ("string" == typeof t5 && (n3.style.cssText = t5 = ""), t5) for (l6 in t5) u5 && l6 in u5 || j(n3.style, l6, "");
    if (u5) for (l6 in u5) t5 && u5[l6] == t5[l6] || j(n3.style, l6, u5[l6]);
  }
  else if ("o" == l6[0] && "n" == l6[1]) r5 = l6 != (l6 = l6.replace(f, "$1")), o4 = l6.toLowerCase(), l6 = o4 in n3 || "onFocusOut" == l6 || "onFocusIn" == l6 ? o4.slice(2) : l6.slice(2), n3.l || (n3.l = {}), n3.l[l6 + r5] = u5, u5 ? t5 ? u5.u = t5.u : (u5.u = c, n3.addEventListener(l6, r5 ? a : s, r5)) : n3.removeEventListener(l6, r5 ? a : s, r5);
  else {
...
function z(n3, u5, t5, i6, r5, o4, e4, f5, c5, s6) {
  var a5, h6, p6, y5, _4, m5, b3, S3, C3, M2, $2, I2, A3, H2, L, T3 = u5.type;
  if (void 0 !== u5.constructor) return null;
  128 & t5.__u && (c5 = !!(32 & t5.__u), o4 = [f5 = u5.__e = t5.__e]), (a5 = l.__b) && a5(u5);
  n: if ("function" == typeof T3) try {
    if (S3 = u5.props, C3 = T3.prototype && T3.prototype.render, M2 = (a5 = T3.contextType) && i6[a5.__c], $2 = a5 ? M2 ? M2.props.value : a5.__ : i6, t5.__c ? b3 = (h6 = u5.__c = t5.__c).__ = h6.__E : (C3 ? u5.__c = h6 = new T3(S3, $2) : (u5.__c = h6 = new x(S3, $2), h6.constructor = T3, h6.render = G), M2 && M2.sub(h6), h6.state || (h6.state = {}), h6.__n = i6, p6 = h6.__d = true, h6.__h = [], h6._sb = []), C3 && null == h6.__s && (h6.__s = h6.state), C3 && null != T3.getDerivedStateFromProps && (h6.__s == h6.state && (h6.__s = w({}, h6.__s)), w(h6.__s, T3.getDerivedStateFromProps(S3, h6.__s))), y5 = h6.props, _4 = h6.state, h6.__v = u5, p6) C3 && null == T3.getDerivedStateFromProps && null != h6.componentWillMount && h6.componentWillMount(), C3 && null != h6.componentDidMount && h6.__h.push(h6.componentDidMount);
    else {
      if (C3 && null == T3.getDerivedStateFromProps && S3 !== y5 && null != h6.componentWillReceiveProps && h6.componentWillReceiveProps(S3, $2), u5.__v == t5.__v || !h6.__e && null != h6.shouldComponentUpdate && false === h6.shouldComponentUpdate(S3, h6.__s, $2)) {
        u5.__v != t5.__v && (h6.props = S3, h6.state = h6.__s, h6.__d = false), u5.__e = t5.__e, u5.__k = t5.__k, u5.__k.some(function(n4) {
          n4 && (n4.__ = u5);
        }), v.push.apply(h6.__h, h6._sb), h6._sb = [], h6.__h.length && e4.push(h6);
        break n;
      }
      null != h6.componentWillUpdate && h6.componentWillUpdate(S3, h6.__s, $2), C3 && null != h6.componentDidUpdate && h6.__h.push(function() {
        h6.componentDidUpdate(y5, _4, m5);
      });
    }
    if (h6.context = $2, h6.props = S3, h6.__P = n3, h6.__e = false, I2 = l.__r, A3 = 0, C3) h6.state = h6.__s, h6.__d = false, I2 && I2(u5), a5 = h6.render(h6.props, h6.state, h6.context), v.push.apply(h6.__h, h6._sb), h6._sb = [];
    else do {
      h6.__d = false, I2 && I2(u5), a5 = h6.render(h6.props, h6.state, h6.context), h6.state = h6.__s;
    } while (h6.__d && ++A3 < 25);
    h6.state = h6.__s, null != h6.getChildContext && (i6 = w(w({}, i6), h6.getChildContext())), C3 && !p6 && null != h6.getSnapshotBeforeUpdate && (m5 = h6.getSnapshotBeforeUpdate(y5, _4)), H2 = null != a5 && a5.type === k && null == a5.key ? q(a5.props.children) : a5, f5 = P(n3, d(H2) ? H2 : [H2], u5, t5, i6, r5, o4, e4, f5, c5, s6), h6.base = u5.__e, u5.__u &= -161, h6.__h.length && e4.push(h6), b3 && (h6.__E = h6.__ = null);
  } catch (n4) {
    ...
    else u5.__e = t5.__e, u5.__k = t5.__k, n4.then || N(u5);
    l.__e(n4, u5, t5);
  }
  else null == o4 && u5.__v == t5.__v ? (u5.__k = t5.__k, u5.__e = t5.__e) : f5 = u5.__e = B(t5.__e, u5, t5, i6, r5, o4, e4, c5, s6);
...
function V(n3, u5, t5) {
  for (var i6 = 0; i6 < t5.length; i6++) D(t5[i6], t5[++i6], t5[++i6]);
...
function B(u5, t5, i6, r5, o4, e4, f5, c5, s6) {
  var a5, h6, v6, y5, w5, _4, m5, b3 = i6.props || p, k3 = t5.props, x4 = t5.type;
  if ("svg" == x4 ? o4 = "http://www.w3.org/2000/svg" : "math" == x4 ? o4 = "http://www.w3.org/1998/Math/MathML" : o4 || (o4 = "http://www.w3.org/1999/xhtml"), null != e4) {
    for (a5 = 0; a5 < e4.length; a5++) if ((w5 = e4[a5]) && "setAttribute" in w5 == !!x4 && (x4 ? w5.localName == x4 : 3 == w5.nodeType)) {
      u5 = w5, e4[a5] = null;
      break;
    }
  }
  if (null == u5) {
    ...
    u5 = document.createElementNS(o4, x4, k3.is && k3), c5 && (l.__m && l.__m(t5, e4), c5 = false), e4 = null;
  }
  if (null == x4) b3 === k3 || c5 && u5.data == k3 || (u5.data = k3);
  else {
    if (e4 = e4 && n.call(u5.childNodes), !c5 && null != e4) for (b3 = {}, a5 = 0; a5 < u5.attributes.length; a5++) b3[(w5 = u5.attributes[a5]).name] = w5.value;
    for (a5 in b3) w5 = b3[a5], "dangerouslySetInnerHTML" == a5 ? v6 = w5 : "children" == a5 || a5 in k3 || "value" == a5 && "defaultValue" in k3 || "checked" == a5 && "defaultChecked" in k3 || F(u5, a5, null, w5, o4);
    for (a5 in k3) w5 = k3[a5], "children" == a5 ? y5 = w5 : "dangerouslySetInnerHTML" == a5 ? h6 = w5 : "value" == a5 ? _4 = w5 : "checked" == a5 ? m5 = w5 : c5 && "function" != typeof w5 || b3[a5] === w5 || F(u5, a5, w5, b3[a5], o4);
    if (h6) c5 || v6 && (h6.__html == v6.__html || h6.__html == u5.innerHTML) || (u5.innerHTML = h6.__html), t5.__k = [];
    else if (v6 && (u5.innerHTML = ""), P("template" == t5.type ? u5.content : u5, d(y5) ? y5 : [y5], t5, i6, r5, "foreignObject" == x4 ? "http://www.w3.org/1999/xhtml" : o4, e4, f5, e4 ? e4[0] : i6.__k && S(i6, 0), c5, s6), null != e4) for (a5 = e4.length; a5--; ) g(e4[a5]);
    c5 || (a5 = "value", "progress" == x4 && null == _4 ? u5.removeAttribute("value") : null != _4 && (_4 !== u5[a5] || "progress" == x4 && !_4 || "option" == x4 && _4 != b3[a5]) && F(u5, a5, _4, b3[a5], o4), a5 = "checked", null != m5 && m5 != u5[a5] && F(u5, a5, m5, b3[a5], o4));
  }
  return u5;
}
function D(n3, u5, t5) {
...
function E(n3, u5, t5) {
  var i6, r5;
  if (l.unmount && l.unmount(n3), (i6 = n3.ref) && (i6.current && i6.current != n3.__e || D(i6, null, u5)), null != (i6 = n3.__c)) {
  ...
  if (i6 = n3.__k) for (r5 = 0; r5 < i6.length; r5++) i6[r5] && E(i6[r5], u5, t5 || "function" != typeof n3.type);
...
function J(u5, t5, i6) {
  var r5, o4, e4, f5;
  t5 == document && (t5 = document.documentElement), l.__ && l.__(u5, t5), o4 = (r5 = "function" == typeof i6) ? null : i6 && i6.__k || t5.__k, e4 = [], f5 = [], z(t5, u5 = (!r5 && i6 || t5).__k = _(k, null, [u5]), o4 || p, p, t5.namespaceURI, !r5 && i6 ? [i6] : o4 ? null : t5.firstChild ? n.call(t5.childNodes) : null, e4, !r5 && i6 ? i6 : o4 ? o4.__e : t5.firstChild, r5, f5), V(e4, u5, f5);
}
function K(n3, l6) {
  J(n3, l6, K);
}
function Q(l6, u5, t5) {
  var i6, r5, o4, e4, f5 = w({}, l6.props);
  ...
  return arguments.length > 2 && (f5.children = arguments.length > 3 ? n.call(arguments, 2) : t5), m(l6.type, f5, i6 || l6.key, r5 || l6.ref, null);
}
function R(n3) {
  function l6(n4) {
    var u5, t5;
...
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = v.slice, l = { __e: function(n3, l6, u5, t5) {
      ...
      var u5;
      u5 = null != this.__s && this.__s != this.state ? this.__s : this.__s = w({}, this.state), "function" == typeof n3 && (n3 = n3(w({}, u5), this.props)), n3 && w(u5, n3), null != n3 && this.__v && (l6 && this._sb.push(l6), $(this));
...
var init_devtools_module = __esm({
  "node_modules/preact/devtools/dist/devtools.module.js"() {
    init_preact_module();
    null != (i4 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) && i4.__PREACT_DEVTOOLS__ && i4.__PREACT_DEVTOOLS__.attachPreact("10.29.0", l, { Fragment: k, Component: x });
  }
});
...
function a4(e4) {
  return e4.type === k ? "Fragment" : "function" == typeof e4.type ? e4.type.displayName || e4.type.name : "string" == typeof e4.type ? e4.type : "#text";
}
function c4() {
  return i5.length > 0 ? i5[i5.length - 1] : null;
}
function u4(e4) {
  return "function" == typeof e4.type && e4.type != k;
}
function f4(n3) {
...
function h5(n3) {
  return n3 ? "function" == typeof n3.type ? null == n3.__ ? null != n3.__e && null != n3.__e.parentNode ? n3.__e.parentNode.localName : "" : h5(n3.__) : n3.type : "";
}
function y4(n3) {
...
var init_debug_module = __esm({
  "node_modules/preact/debug/dist/debug.module.js"() {
    ...
    v5 = x.prototype.setState;
    x.prototype.setState = function(n3, e4) {
      return null == this.__v && null == this.state && console.warn('Calling "this.setState" inside the constructor of a component is a no-op and might be a bug in your application. Instead, set "this.state = {}" directly.\n\n' + f4(c4())), v5.call(this, n3, e4);
    };
    m4 = /^(address|article|aside|blockquote|details|div|dl|fieldset|figcaption|figure|footer|form|h1|h2|h3|h4|h5|h6|header|hgroup|hr|main|menu|nav|ol|p|pre|search|section|table|ul)$/;
    b2 = x.prototype.forceUpdate;
    x.prototype.forceUpdate = function(n3) {
...
` + f4(n3));
      ...
      var n3 = false, o4 = l.__b, r5 = l.diffed, c5 = l.vnode, l6 = l.__r, v6 = l.__e, b3 = l.__, g3 = l.__h, E3 = d5 ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, k3 = [];
      ...
      l.__r = function(e4) {
        l6 && l6(e4), n3 = true;
        var o5 = e4.__c;
        if (o5 === T3 ? _4++ : _4 = 1, _4 >= 25) throw new Error("Too many re-renders. This is limited to prevent an infinite loop which may lock up your browser. The component causing this is: " + a4(e4));
        T3 = o5;
      ...
      l.vnode = function(n4) {
        ...
        }), e4.__c === T3 && (_4 = 0), "string" == typeof t5 && (y4(t5) || "p" === t5 || "a" === t5 || "button" === t5)) {
          var s6 = h5(i6);
        ...
        if (null != e4.__c && null != e4.__c.__H) {
          ...
          if (b4) for (var g4 = 0; g4 < b4.length; g4 += 1) {
            var E4 = b4[g4];
            if (E4.__H) {
...
function a3(i6) {
  if (void 0 !== r3) {
    ...
    if (void 0 === t5 || t5.t !== r3) {
      t5 = { i: 0, S: i6, p: r3.s, n: void 0, t: r3, e: void 0, x: void 0, r: t5 };
...
l3.prototype.S = function(i6) {
  ...
  if (n3 !== i6 && void 0 === i6.e) {
    i6.x = n3;
    this.t = i6;
    if (void 0 !== n3) n3.e = i6;
    else o3(function() {
      var i7;
...
var s4;
function l4(i6, n3) {
  l[i6] = n3.bind(null, l[i6] || function() {
  });
}
function d4(i6) {
  if (s4) {
...
function h4(i6) {
  var r5 = this, f5 = i6.data, o4 = useSignal(f5);
  o4.value = f5;
  var e4 = T2(function() {
    var i7 = r5.__v;
    ...
    r5.__$u.c = function() {
      var i8, t5 = r5.__$u.S(), f6 = e4.value;
      t5();
      if (t(f6) || 3 !== (null == (i8 = r5.base) ? void 0 : i8.nodeType)) {
        r5.__$f |= 1;
        r5.setState({});
...
l4("__r", function(i6, r5) {
  i6(r5);
  d4();
  var n3, t5 = r5.__c;
  if (t5) {
    t5.__$f &= -2;
    if (void 0 === (n3 = t5.__$u)) t5.__$u = n3 = (function(i7) {
      var r6;
      j3(function() {
        r6 = this;
      });
...
l4("__e", function(i6, r5, n3, t5) {
  d4();
  v4 = void 0;
  i6(r5, n3, t5);
});
l4("diffed", function(i6, r5) {
  d4();
  v4 = void 0;
  var n3;
...
function p4(i6, r5, n3, t5) {
  var f5 = r5 in i6 && void 0 === i6.ownerSVGElement, o4 = y3(n3);
  return { o: function(i7, r6) {
    o4.value = i7;
    t5 = r6;
  }, d: j3(function() {
    ...
    if (t5[r5] !== n4) {
      t5[r5] = n4;
      if (f5) i6[r5] = n4;
      else if (n4) i6.setAttribute(r5, n4);
      else i6.removeAttribute(r5);
    }
  }) };
}
l4("unmount", function(i6, r5) {
  if ("string" == typeof r5.type) {
    var n3 = r5.__e;
    if (n3) {
      var t5 = n3.U;
...
l4("__h", function(i6, r5, n3, t5) {
  if (t5 < 3 || 9 === t5) r5.__$f |= 2;
  i6(r5, n3, t5);
});
x.prototype.shouldComponentUpdate = function(i6, r5) {
  ...
  for (var o4 in i6) if ("__source" !== o4 && i6[o4] !== this.props[o4]) return true;
  for (var e4 in this.props) if (!(e4 in i6)) return true;
  return false;
};
...
// node_modules/@wordpress/interactivity/build-module/directives.mjs
init_preact_module();

// node_modules/@wordpress/interactivity/build-module/namespaces.mjs
var namespaceStack = [];
...
// node_modules/@wordpress/interactivity/build-module/scopes.mjs
var scopeStack = [];
...
var navigationContextSignal = y3(0);
...
// node_modules/@wordpress/interactivity/build-module/utils.mjs
...
// node_modules/@wordpress/interactivity/build-module/hooks.mjs
init_preact_module();

// node_modules/@wordpress/interactivity/build-module/proxies/registry.mjs
...
// node_modules/@wordpress/interactivity/build-module/proxies/signals.mjs
var NO_SCOPE = {};
var PropSignal = class {
  ...
  update({ get, value }) {
    if (!this.valueSignal) {
      this.valueSignal = y3(value);
      this.getterSignal = y3(get);
...
// node_modules/@wordpress/interactivity/build-module/proxies/state.mjs
...
var deepMerge = (target, source, override = true) => n2(
  () => deepMergeRecursive(
...
// node_modules/@wordpress/interactivity/build-module/proxies/store.mjs
...
// node_modules/@wordpress/interactivity/build-module/proxies/context.mjs
...
// node_modules/@wordpress/interactivity/build-module/store.mjs
...
var Directives = ({
  ...
  element = Q(element, { ref: scope.ref });
...
// node_modules/@wordpress/interactivity/build-module/hydration.mjs
init_preact_module();

// node_modules/@wordpress/interactivity/build-module/vdom.mjs
init_preact_module();
...
// dist/blablablocks-tabs-view.js
var __webpack_modules__ = {
  ...
  "@wordpress/interactivity": (
    ...
    /***/
    ((module) => {
      module.exports = build_module_exports;
    })
  )
  /******/
};
...
(() => {
  ...
  var _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! @wordpress/interactivity */
    "@wordpress/interactivity"
  );
  ...
  const removeCSSString = (element, cssString) => {
    ...
    cssString.split(";").forEach((rule) => {
      const [property] = rule.split(":").map((s6) => s6.trim());
      if (property) {
  ...
  const {
    ...
    state: {
      ...
      get activeTabIndex() {
        ...
        const tabIndex = tabs.findIndex((t5) => t5.id === tabId);
        return tabIndex;
      },
      /**
    ...
    actions: {
      ...
      handleOnKeyDown: (0, _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.withSyncEvent)((event) => {
        ...
        const context2 = (0, _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getContext)();
        const {
          tabs
        } = context2;
        ...
        switch (event.key) {
          case "Enter":
          case " ":
            context2.activeTab = tabIndex;
            break;
          case "ArrowRight":
            newIndex = (tabIndex + 1) % tabs.length;
            context2.activeTab = newIndex;
            break;
          case "ArrowLeft":
      ...
      setActiveTab: () => {
        ...
        const tabIndex = state.activeTabIndex;
        if (tabIndex !== null) {
          context2.activeTab = state.activeTabIndex;
        }
      }
    },
    callbacks: {
      ...
      initTabs() {
        const context2 = (0, _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getContext)();
        const tabIndex = context2.tabs.findIndex((t5) => t5.id === context2.activeId);
        if (tabIndex >= 0) {
          context2.activeTab = tabIndex;
        }
      },
